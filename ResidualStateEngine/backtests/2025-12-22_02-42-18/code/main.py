...
class ResidualStateEngineAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.SetWarmUp(self.lookback_returns + 60, Resolution.Daily)
    ...
    def Rebalance(self):
        ...
        if gross > 0:
            w_candidate = w_candidate * (self.gross_leverage / gross)
    ...
    def _load_parameters(self):
        ...
        self.start_date = self._get_date_param("start_date", datetime(2013, 1, 1))
        self.end_date = self._get_date_param("end_date", datetime(2024, 1, 1))
    ...
    def _log_state(self, state, w, strength, neutrality_err, energy, turnover, alignment, T):
        ...
        self.Debug(
            ...
            "neutrality_err={9:.6f} | state={10}".format(
                self.Time.date(),
                self.N,
                self.K,
                T,
